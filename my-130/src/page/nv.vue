<template>
	<div>
		...
		<swiper :options="swiperOption" ref="mySwiper" class="my-swiper">
		    <!-- slides -->
		    <swiper-slide><img src="https://img3.cache.netease.com/news/2017/9/27/20170927182049c27be.jpg"/></swiper-slide>
		    <swiper-slide><img src="https://easyreadfs.nosdn.127.net/HrHj51Aub27JDhCtxrcKZQ==/8796093023196926869?param=460x150"/></swiper-slide>
		</swiper>
		<!--都市生活-->
...
<script>
	...
	export default {
	  ...
	  data(){
		...
		mounted() {
			this.$ajax.get("http://120.76.205.241:8000/book/easyread163?kw=%E5%A5%B3&apikey=jJybHxVKZVuxmoAzRQpZA8HE7iZohVSeW4iz8T3WxMyGdmXbxEqSAdJwQB9pDC6g").then(res => {
